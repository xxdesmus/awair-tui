...
- **`src/api.ts`** — HTTP client for Awair Local API (`/air-data/latest`, `/settings/config/data`). Also contains sensor data types, optimal range constants, and `rateSensorValue()` scoring logic.
